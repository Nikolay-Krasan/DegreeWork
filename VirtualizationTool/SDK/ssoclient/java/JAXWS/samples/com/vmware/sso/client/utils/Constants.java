...
public final class Constants {
	...
	public static final String EXCEPTION_LOADING_THE_PRIVATE_KEY_CERTIFICATES_FROM_FILES = "Exception loading the private key / certificates from files";
	public static final String EXCEPTION_READING_LOADING_THE_USER_CERTIFICATES_FROM_KEYSTORE = "Exception reading loading the user certificates from keystore";
	...
	public static final String URN_OASIS_NAMES_TC_SAML_2_0_CM_HOLDER_OF_KEY = "urn:oasis:names:tc:SAML:2.0:cm:holder-of-key";
